...
➡️ **T3.4 — Risk fusion.** (T3.3 done. Combine rule + image + LLM signals → 0–100 score + band + contributing signals. Cap photo-reuse-alone at "caution"; consider created_at to spare the original.)
